...
function AquaGauge(target) {
    ...
    //clears the canvas: Modified this function!: Aditya Ayachit
    ...
    function drawCenterCircle(cvs, props) {
        ...
        grd.addColorStop(0, '#C7FF32'/*"rgba(75, 75, 75, 0.9)"*/);
        grd.addColorStop(1, '#C7FF32'/*"rgba(130, 130, 130, 0.9)"*/);        
        cvs.ctx.fillStyle = grd;
        cvs.ctx.beginPath();
        ...
        grd.addColorStop(0, '#C7FF32'/*"rgba(255, 255, 255, 0.4)"*/);
        grd.addColorStop(1, '#C7FF32'/*"rgba(255, 255, 255, 0)"*/);
        cvs.ctx.fillStyle = grd;
        cvs.ctx.beginPath();
...
function GaugeParams(cvs) {
    ...
    this.dialColor = "transparent";
    //this.dialGradientColor = "#C1CEC7";
    this.dialValueTextFont = getRelVal(cvs, 27) + "px Trebuchet MS";
    this.dialValueTextColor = "#C1CEC7";
    this.dialTitleTextFont =  getRelVal(cvs, 18) + "px Trebuchet MS";
    this.dialTitleTextColor = "#C1CEC7";
    this.dialTitle = "Outlet Pressure";
    this.dialSubTitleTextFont = getRelVal(cvs, 15) + "px Trebuchet MS";
    this.dialSubTitleTextColor = "#C1CEC7";    
    this.dialSubTitle = "Pressure (Bars)";
    this.showGlossiness = false;
    ...
    this.majorDivisionColor = "#C7FF32";
    this.minorDivisionColor = "#C1CEC7";    
    ...
    //Scale Ranges
    this.rangeSegments = [{ start: 0, end: 400, color: "#C1CEC7" }];
    ...
    this.dialScaleTextColor = "#C7FF32";
    this.dialSubScaleTextColor = "#C1CEC7";
    this.showMinorScaleValue = false;

    //Pointer
    this.pointerColor = "#C1CEC7";
    this.pointerGradientColor = "#C1CEC7";
